...
const Help = () => {
  ...
  const resources = [
    {
      title: "Salaried Individuals Tax Guide",
      description: "A guide to filing your taxes correclty",
      icon: "📋",
      link: "/individual-huf/salaried-employees"
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
            ...
            <div className="mt-8 p-6 bg-blue-50 rounded-lg">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <p className="text-gray-700">Budget 2025: Changes to tax slabs and implications for taxpayers</p>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
              ...
              <a href="latest-updates" className="block mt-4 text-blue-600 hover:text-blue-800 font-medium">
        ...
        <div className="mt-12 bg-gray-50 rounded-lg p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="file-tax" className="flex flex-col items-center p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
            ...
            <a href="/login/forgotPassword" className="flex flex-col items-center p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-600 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
              </svg>
              <span className="text-gray-700 text-center">Reset Password</span>
            </a>
            <a href="/individual-huf/salaried-employees" className="flex flex-col items-center p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-600 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <span className="text-gray-700 text-center">View Tax Forms of Salaried Employees</span>
            </a>
            <a href="/" className="flex flex-col items-center p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <span className="text-gray-700 text-center">Download Brochers</span>
            </a>
          </div>
        </div>
      </div>
