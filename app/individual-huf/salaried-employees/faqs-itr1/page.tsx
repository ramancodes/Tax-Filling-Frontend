...
export default function ITR1FAQ() {
  ...
  return (
    <div className="container mx-auto px-4 max-w-4xl py-8">
      <Head>
        <title>File ITR-1 (Sahaj) Online - FAQs | Income Tax Department</title>
        <meta name="description" content="Frequently Asked Questions about filing ITR-1 Sahaj form online" />
      </Head>

      <h1 className="text-3xl font-bold text-center text-gray-800 mb-8">File ITR-1 (Sahaj) Online - FAQs</h1>
