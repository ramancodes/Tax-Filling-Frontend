            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
                <div className="p-6 text-center">
                  ...
                  <Link href="/individual-taxes" className="text-primary hover:underline">
                    Learn More
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
                <div className="p-6 text-center">
                  ...
                  <Link href="/business-taxes" className="text-primary hover:underline">
                    Learn More
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
                <div className="p-6 text-center">
                  ...
                  <Link href="/tax-calculator" className="text-primary hover:underline">
                    Learn More
                  </Link>
                </div>
              </div>
